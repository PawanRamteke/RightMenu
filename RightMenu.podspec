...
Pod::Spec.new do |s|
  s.name             = "RightMenu"
  s.version          = "0.1.0"
  s.summary          = "A short description of RightMenu."
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = "https://github.com/<GITHUB_USERNAME>/RightMenu"
  # s.screenshots     = "www.example.com/screenshots_1", "www.example.com/screenshots_2"
  s.license          = 'MIT'
  s.author           = { "Pawan Ramteke" => "pawanramteke7@gmail.com" }
  s.source           = { :git => "https://github.com/<GITHUB_USERNAME>/RightMenu.git", :tag => s.version.to_s }
